...
def make_model(input_dir: str, schema: str, species: str,
               metric: str, iterative_learning: bool, print_metrics: bool) -> ModelWrapper:
    ...
    return abstract_random_forest.make_model(X_train, y_train, X_val, y_val, test_pool, y_test, annotation,
                                             HeavyChainType.V1, metric, iterative_learning, print_metrics, marker)


def main(input_dir, schema, metric, output_dir, species, iterative_learning, print_metrics):
    wrapped_model = make_model(input_dir, schema, species, metric, iterative_learning, print_metrics)
...
if __name__ == '__main__':
    ...
    main(input_dir=args.input, schema=args.schema, metric=args.metric, output_dir=args.output, species=args.species,
         iterative_learning=args.iterative_learning, print_metrics=args.print_metrics)
